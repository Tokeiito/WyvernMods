...
import org.gotti.wurmunlimited.mods.wyvernmods.Crystals;
				...
				try{
					if(performer instanceof Player){
						...
						if(counter == 1.0f){
							...
							double power = performer.getSkills().getSkill(SkillList.ARTIFACTS).skillCheck(diff, source, 0d, false, 1);
							if(power > 90){
